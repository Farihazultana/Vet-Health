...
class HomePoultryManagement extends StatefulWidget {
  const HomePoultryManagement({super.key});

  @override
  State<HomePoultryManagement> createState() => _HomePoultryManagement();
}

class _HomePoultryManagement extends State<HomePoultryManagement> with TickerProviderStateMixin {
  @override
