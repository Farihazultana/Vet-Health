...
class HomeAquaManagement extends StatefulWidget {
  const HomeAquaManagement({super.key});

  @override
  State<HomeAquaManagement> createState() => _HomeAquaManagement();
}

class _HomeAquaManagement extends State<HomeAquaManagement>
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Scaffold(
          backgroundColor:
              const Color.fromARGB(255, 55, 157, 170).withOpacity(0.3),
          body: Column(
            children: [
              const SizedBox(
                height: 10,
